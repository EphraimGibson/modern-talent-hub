      ...
      <div className="section-container">
        ...
        <div className="flex flex-wrap justify-center gap-3 mb-10">
          <Button
            ...
            className={filter === null ? "bg-accent-green" : ""}
          ...
          {allTags.map((tag) => (
            <Button
              ...
              className={filter === tag ? "bg-accent-green" : ""}
          ...
          {filteredProjects.map((project, index) => (
            <Card key={project.title} className="overflow-hidden card-hover">
                  ...
                  <div className="w-full">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {project.tags.map((tag) => (
                        <span
                          key={tag}
                          className="px-2 py-1 bg-accent-green/90 rounded-md text-xs font-medium text-white"
                        >
                          {tag}
                        </span>
                      ))}
              ...
              <CardFooter className="px-6 pb-6 pt-0 flex gap-3">
                <Button variant="default" className="bg-accent-green" asChild>
                  <a
